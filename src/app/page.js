        ...
        <div className="page-wrapper">
          ...
          <header className="site-header header-style-1">
                    ...
                    <div className="pbmit-logo-button-area d-flex justify-content-between align-items-center">
                      <div className="site-branding">
                        <h1 className="site-title">
                          <a href="index-2.html">
                            <img className="logo-img" src="images/logo.svg" alt="Xinterio" />
                          </a>
                        </h1>
                      ...
                      <div className="pbmit-button-box">
                        <div className="pbmit-header-button">
                          <a href="tel:+1(212)%20255-511">
                            ...
                            <span className="pbmit-header-button-text-2">tel:+1(212) 255-511</span>
                          </a>
                        </div>
                      </div>
                    </div>
            ...
            <div className="pbmit-slider-area pbmit-slider-one">
              <div className="swiper-slider" data-autoplay="true" data-loop="true" data-dots="true" data-arrows="false" data-columns={1} data-margin={0} data-effect="fade">
                <div className="swiper-wrapper">
                  {/* Slide1 */}
                  <div className="swiper-slide">
                    <div className="pbmit-slider-item">
                      <div className="pbmit-slider-bg" style={{ backgroundImage: 'url(images/banner-slider-img/demo1-slide-01.jpg)' }} />
                      <div className="container">
                        <div className="row text-center">
                          <div className="col-md-12">
                            <div className="pbmit-slider-content">
                              <h5 className="pbmit-sub-title transform-top transform-delay-1">barcelona,spain</h5>
                              ...
                              <div className="pbmit-button transform-scale transform-delay-3">
                                <a className="pbmit-btn pbmit-btn-outline" href="contact-us.html">
                                  <span className="pbmit-button-content-wrapper">
                                    <span className="pbmit-button-text">Appeal To</span>
                                  </span>
                                </a>
                              </div>
                            </div>
                  ...
                  <div className="swiper-slide">
                    <div className="pbmit-slider-item">
                      <div className="pbmit-slider-bg" style={{ backgroundImage: 'url(images/banner-slider-img/demo1-slide-02.jpg)' }} />
                      <div className="container">
                        <div className="row text-center">
                          <div className="col-md-12">
                            <div className="pbmit-slider-content">
                              <h5 className="pbmit-sub-title transform-top transform-delay-1">Xinterio features</h5>
                              <h2 className="pbmit-title transform-scale transform-delay-2">
                              ...
                              <div className="pbmit-button transform-scale transform-delay-3">
                                <a className="pbmit-btn pbmit-btn-outline" href="contact-us.html">
                                  <span className="pbmit-button-content-wrapper">
                                    <span className="pbmit-button-text">Take Counsel</span>
                                  </span>
                                </a>
                              </div>
                            </div>
                  ...
                  <div className="swiper-slide">
                    <div className="pbmit-slider-item">
                      <div className="pbmit-slider-bg" style={{ backgroundImage: 'url(images/banner-slider-img/demo1-slide-03.jpg)' }} />
                      <div className="container">
                        <div className="row text-center">
                          <div className="col-md-12">
                            <div className="pbmit-slider-content">
                              <h5 className="pbmit-sub-title transform-top transform-delay-1">Design Business</h5>
                              <h2 className="pbmit-title transform-scale transform-delay-2">
                ...
                <div className="pbmit-slider-dots-corner">
                  <div className="pbmit-sticky-corner pbmit-top-right-corner">
                    <svg width={20} height={20} viewBox="0 0 20 20" fill xmlns="http://www.w3.org/2000/svg" data-stylerecorder="true">
                      <path d="M20 20V0C20 16 16 20 0 20H20Z" fill="red" data-stylerecorder="true" />
                    </svg>
                  </div>
                  <div className="pbmit-sticky-corner pbmit-bottom-left-corner">
                    <svg width={20} height={20} viewBox="0 0 20 20" fill xmlns="http://www.w3.org/2000/svg" data-stylerecorder="true">
          ...
          <div className="page-content">
                        ...
                        <div className="pbmit-ihbox-style-12">
                          <div className="pbmit-ihbox-headingicon">
                            ...
                            <div className="pbmit-ihbox-contents">
                              <h2 className="pbmit-element-title">Best Awarded <br />Company </h2>
                            </div>
                            <div className="pbmit-sticky-corner  pbmit-bottom-left-corner">
                  ...
                  <div className="col-md-12 col-xl-6">
                    <div className="about-one-rightbox">
                      <div className="pbmit-heading-subheading animation-style2">
                        ...
                        <h2 className="pbmit-title">We design thoughtful, liveable spaces.</h2>
                      ...
                      <div className="pbmit-ihbox pbmit-ihbox-style-5 pt-5">
                        <div className="pbmit-ihbox-box d-flex align-items-center">
                          <div className="pbmit-content-wrapper">
                            <h2 className="pbmit-element-title">Jemilin E william</h2>
                      ...
                      <div className="pbmit-fld-contents">
                        <div className="pbmit-fld-wrap">
                          <div className="pbmit-fid-icon-title">
                            ...
                            <span className="pbmit-fid-title">Happy Client Review</span>
                          </div>
                          <h4 className="pbmit-fid-inner">
                            <span className="pbmit-fid-before" />
                            <span className="pbmit-number-rotate numinate" data-appear-animation="animateDigits" data-from={0} data-to={235} data-interval={1} data-before data-before-style data-after data-after-style>235</span>
                    ...
                    <div className="pbminfotech-ele-fid-style-2">
                      <div className="pbmit-fld-contents">
                        <div className="pbmit-fld-wrap">
                          ...
                          <h4 className="pbmit-fid-inner">
                            <span className="pbmit-fid-before" />
                            <span className="pbmit-number-rotate numinate" data-appear-animation="animateDigits" data-from={0} data-to={420} data-interval={1} data-before data-before-style data-after data-after-style>420</span>
                            <span className="pbmit-fid"><sup>+</sup></span>
                          </h4>
                        </div>
                      </div>
                    ...
                    <div className="pbminfotech-ele-fid-style-2">
                      <div className="pbmit-fld-contents">
                        <div className="pbmit-fld-wrap">
                          ...
                          <h4 className="pbmit-fid-inner">
                            <span className="pbmit-fid-before" />
                            <span className="pbmit-number-rotate numinate" data-appear-animation="animateDigits" data-from={0} data-to={30} data-interval={1} data-before data-before-style data-after data-after-style>30</span>
                            <span className="pbmit-fid"><span>K</span></span>
                          </h4>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pbminfotech-ele-fid-style-2">
                      <div className="pbmit-fld-contents">
                        <div className="pbmit-fld-wrap">
                          ...
                          <h4 className="pbmit-fid-inner">
                            <span className="pbmit-fid-before" />
                            <span className="pbmit-number-rotate numinate" data-appear-animation="animateDigits" data-from={0} data-to={305} data-interval={1} data-before data-before-style data-after data-after-style>305</span>
                            <span className="pbmit-fid"><sup>+</sup></span>
                          </h4>
                        </div>
                      </div>
            ...
            <section className="pbmit-extend-animation service-one pbmit-bg-color-secondary">
              <div className="container">
                ...
                <div className="swiper-slider" data-autoplay="false" data-loop="true" data-dots="false" data-arrows="false" data-columns={3} data-margin={30} data-effect="slide">
                  <div className="swiper-wrapper">
                    {/* Slide1 */}
                    <article className="pbmit-ele-service pbmit-service-style-2 swiper-slide">
                      <div className="pbminfotech-post-item">
                          ...
                          <div className="pbmit-service-image-wrapper">
                            <div className="pbmit-featured-img-wrapper">
                              <div className="pbmit-featured-wrapper">
                                <img src="images/homepage-1/service/service-01.jpg" className="img-fluid" alt="service-01" />
                              </div>
                            </div>
                          </div>
                        ...
                        <a className="pbmit-service-btn" href="service-details.html" title="Transforming Rooms">
                      ...
                      <div className="pbminfotech-post-item">
                        <div className="pbminfotech-box-content">
                          <div className="pbmit-service-image-wrapper">
                            <div className="pbmit-featured-img-wrapper">
                              <div className="pbmit-featured-wrapper">
                                <img src="images/homepage-1/service/service-02.jpg" className="img-fluid" alt="service-01" />
                              </div>
                            </div>
                          </div>
                          <div className="pbmit-service-icon elementor-icon">
                        ...
                        <a className="pbmit-service-btn" href="service-details.html" title="Weaving Dreams">
                          <span className="pbmit-button-icon">
                            <i className="pbmit-base-icon-pbmit-up-arrow" />
                          </span>
                        </a>
                      ...
                      <div className="pbminfotech-post-item">
                        <div className="pbminfotech-box-content">
                          <div className="pbmit-service-image-wrapper">
                            <div className="pbmit-featured-img-wrapper">
                              <div className="pbmit-featured-wrapper">
                                <img src="images/homepage-1/service/service-03.jpg" className="img-fluid" alt="service-01" />
                              </div>
                            </div>
                          </div>
                          <div className="pbmit-service-icon elementor-icon">
                        ...
                        <a className="pbmit-service-btn" href="service-details.html" title="Interior Decorator">
                          <span className="pbmit-button-icon">
                            <i className="pbmit-base-icon-pbmit-up-arrow" />
                          </span>
                        </a>
                      ...
                      <div className="pbminfotech-post-item">
                        <div className="pbminfotech-box-content">
                          <div className="pbmit-service-image-wrapper">
                            <div className="pbmit-featured-img-wrapper">
                              <div className="pbmit-featured-wrapper">
                                <img src="images/homepage-1/service/service-04.jpg" className="img-fluid" alt="service-01" />
                              </div>
                            </div>
                          </div>
                          <div className="pbmit-service-icon elementor-icon">
                        ...
                        <a className="pbmit-service-btn" href="service-details.html" title="Professional Interior">
                          <span className="pbmit-button-icon">
                            <i className="pbmit-base-icon-pbmit-up-arrow" />
                          </span>
                        </a>
                      ...
                      <div className="pbminfotech-post-item">
                        <div className="pbminfotech-box-content">
                          <div className="pbmit-service-image-wrapper">
                            <div className="pbmit-featured-img-wrapper">
                              <div className="pbmit-featured-wrapper">
                                <img src="images/homepage-1/service/service-05.jpg" className="img-fluid" alt="service-01" />
                              </div>
                            </div>
                          </div>
                          <div className="pbmit-service-icon elementor-icon">
                        ...
                        <a className="pbmit-service-btn" href="service-details.html" title="Interior Work Plan">
                          <span className="pbmit-button-icon">
                            <i className="pbmit-base-icon-pbmit-up-arrow" />
                          </span>
                        </a>
                ...
                <div className="text-center">
                  <div className="pbmit-service-text">
                    <p>Need more services based on your demand? <span className="pbmit-globalcolor">Contact us</span></p>
                  </div>
                </div>
              </div>
            </section>
                ...
                <div className="row align-items-center">
                        ...
                        <div className="pbmit-ihbox-style-8">
                          <div className="pbmit-ihbox-box d-flex">
                            ...
                            <div className="pbmit-ihbox-contents">
                              ...
                              <div className="pbmit-heading-desc">We offer competitive and affordable rates for our interior design .</div>
                            </div>
                          </div>
                        </div>
                      </article>
                  ...
                  <div className="col-md-6 ihbox-one-img-col">
                    <div className="ihbox-imgbox">
                      <img src="images/homepage-1/ih-single-img-01.png" className="img-fluid" alt />
                    </div>
                  </div>
                  ...
                  <div className="swiper-wrapper">
                    <article className="pbmit-marquee-effect-style-1 swiper-slide">
                      <div className="pbmit-tag-wrapper">
                        <h2 className="pbmit-element-title" data-text="Master Bedroom ">
                          Master Bedroom
                        </h2>
                      </div>
                    </article>
                    <article className="pbmit-marquee-effect-style-1 swiper-slide">
                      <div className="pbmit-tag-wrapper">
                        <h2 className="pbmit-element-title" data-text="Living Room">
                          Living Room
                        </h2>
                      </div>
                    </article>
                    ...
                    <article className="pbmit-marquee-effect-style-1 swiper-slide">
                      <div className="pbmit-tag-wrapper">
                        <h2 className="pbmit-element-title" data-text="Best Gallery">
                          Best Gallery
                        </h2>
                      </div>
                    </article>
                  ...
                  <div className="col-md-12 col-xl-8">
                    <div className="pbmit-sortable-list">
                      <ul className="pbmit-sortable-list-ul">
                        <li><a href="#" className="pbmit-sortable-link pbmit-selected" data-category="*" data-sortby="*">All</a></li>
                        <li><a href="#" className="pbmit-sortable-link" data-sortby="architecture">Architecture</a></li>
                        <li><a href="#" className="pbmit-sortable-link" data-sortby="bedroom">Bedroom</a></li>
                        <li><a href="#" className="pbmit-sortable-link" data-sortby="furniture">Furniture</a></li>
                        <li><a href="#" className="pbmit-sortable-link" data-sortby="interior">Interior</a></li>
                        <li><a href="#" className="pbmit-sortable-link" data-sortby="kitchen">Kitchen</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                <div className="row pbmit-element-posts-wrapper">
                  <article className="pbmit-portfolio-style-3 col-md-4 bedroom">
                    <div className="pbminfotech-post-content">
                      <div className="pbmit-featured-img-wrapper">
                        <div className="pbmit-featured-wrapper">
                          <img src="images/homepage-1/portfolio/portfolio-01.jpg" className="img-fluid" alt="portfolio-01" />
                        </div>
                      </div>
                      <div className="pbminfotech-box-content">
                      ...
                      <a className="pbmit-link" href="portfolio-detail-style-1.html" />
                    </div>
                  </article>
                  <article className="pbmit-portfolio-style-3 col-md-4 furniture">
                    <div className="pbminfotech-post-content">
                      <div className="pbmit-featured-img-wrapper">
                        <div className="pbmit-featured-wrapper">
                          <img src="images/homepage-1/portfolio/portfolio-02.jpg" className="img-fluid" alt="portfolio-01" />
                        </div>
                      </div>
                      <div className="pbminfotech-box-content">
                        <div className="pbminfotech-titlebox">
                  ...
                  <article className="pbmit-portfolio-style-3 col-md-4 interior">
                    <div className="pbminfotech-post-content">
                      <div className="pbmit-featured-img-wrapper">
                        <div className="pbmit-featured-wrapper">
                          <img src="images/homepage-1/portfolio/portfolio-03.jpg" className="img-fluid" alt="portfolio-01" />
                        </div>
                      </div>
                      <div className="pbminfotech-box-content">
                        <div className="pbminfotech-titlebox">
                  ...
                  <article className="pbmit-portfolio-style-3 col-md-4 kitchen">
                    <div className="pbminfotech-post-content">
                      <div className="pbmit-featured-img-wrapper">
                        <div className="pbmit-featured-wrapper">
                          <img src="images/homepage-1/portfolio/portfolio-04.jpg" className="img-fluid" alt="portfolio-01" />
                        </div>
                      </div>
                      <div className="pbminfotech-box-content">
                        <div className="pbminfotech-titlebox">
                  ...
                  <article className="pbmit-portfolio-style-3 col-md-4 bedroom">
                    <div className="pbminfotech-post-content">
                      <div className="pbmit-featured-img-wrapper">
                        <div className="pbmit-featured-wrapper">
                          <img src="images/homepage-1/portfolio/portfolio-05.jpg" className="img-fluid" alt="portfolio-01" />
                        </div>
                      </div>
                      <div className="pbminfotech-box-content">
                        <div className="pbminfotech-titlebox">
                  ...
                  <article className="pbmit-portfolio-style-3 col-md-4 architecture">
                    <div className="pbminfotech-post-content">
                      <div className="pbmit-featured-img-wrapper">
                        <div className="pbmit-featured-wrapper">
                          <img src="images/homepage-1/portfolio/portfolio-06.jpg" className="img-fluid" alt="portfolio-01" />
                        </div>
                      </div>
                      <div className="pbminfotech-box-content">
                        <div className="pbminfotech-titlebox">
                    ...
                    <div className="pbminfotech-ele-ptable-style-1">
                      <div className="pbmit-ptable-cols row">
                        <div className="pbmit-ptable-col col-md-6">
                          <div className="pbmit-pricing-table-box">
                            <div className="pbmit-head-wrap">
                              <h3 className="pbminfotech-ptable-heading">Basic Plan</h3>
                              ...
                              <div className="pbmit-price-wrapper">
                                <div className="pbmit-ptable-price-w">
                                  ...
                                  <div className="pbminfotech-ptable-price">27</div>
                                </div>
                            ...
                            <div className="pbmit-ptable-inner">
                              <div className="pbmit-ptable-lines-w">
                                <div className="pbmit-ptable-line">Individuals &amp; small projects</div>
                                <div className="pbmit-ptable-line">Access to design features</div>
                                <div className="pbmit-ptable-line">Limited library of decorative items</div>
                                <div className="pbmit-ptable-line">Email support</div>
                                <div className="pbmit-ptable-line">Monthly updates</div>
                              </div>
                              <div className="pbminfotech-ptable-btn">
                                <div className="pbmit-button">
                                  <a className="pbmit-button-inner" href="about-mask-img.html">
                        ...
                        <div className="pbmit-pricing-table-featured-col pbmit-ptable-col col-md-6">
                          <div className="pbmit-pricing-table-box">
                            <div className="pbmit-head-wrap">
                              <h3 className="pbminfotech-ptable-heading">Advance</h3>
                              <div className="pbminfotech-sep" />
                              <div className="pbmit-price-wrapper">
                                <div className="pbmit-ptable-price-w">
                                  <div className="pbminfotech-ptable-symbol">$</div>
                                  <div className="pbminfotech-ptable-price">47</div>
                                </div>
                                <div className="pbminfotech-ptable-frequency">/mo</div>
                              </div>
                            </div>
                  ...
                  <div className="col-md-12 col-xl-5">
                    <div className="pricing-one-rightbox">
                      <div className="pbmit-heading-subheading animation-style2">
                        ...
                        <h2 className="pbmit-title">Choose plan for house interior</h2>
                      </div>
                      <ul className="list-group list-group-borderless">
                        <li className="list-group-item">
                          <span className="pbmit-icon-list-icon">
                            <i aria-hidden="true" className="pbmit-xinterio-icon pbmit-xinterio-icon-check-mark" />
                          </span>
                          <span className="pbmit-icon-list-text">Get 30 day free trial</span>
                        </li>
                        <li className="list-group-item">
                          <span className="pbmit-icon-list-icon">
                            <i aria-hidden="true" className="pbmit-xinterio-icon pbmit-xinterio-icon-wallet" />
                          </span>
                          <span className="pbmit-icon-list-text">No any hidden fees pay</span>
                        </li>
                        <li className="list-group-item">
                          <span className="pbmit-icon-list-icon">
                            <i aria-hidden="true" className="pbmit-xinterio-icon pbmit-xinterio-icon-clock" />
                          </span>
                          <span className="pbmit-icon-list-text">You can cancel anytime</span>
                        </li>
                      </ul>
                      <a className="pbmit-btn pbmit-btn-outline" href="our-history.html">
                        <span className="pbmit-button-content-wrapper">
                ...
                <div className="pbmit-col-stretched-right">
                  <div className="row g-0">
                    ...
                    <div className="col-md-12 col-lg-9 pbmit-testimonialbox-right">
                      <div className="swiper-slider" data-autoplay="true" data-loop="true" data-dots="false" data-arrows="true" data-columns="2.6" data-margin={30} data-effect="slide">
                        <div className="swiper-wrapper">
                          {/* Slide1 */}
                              ...
                              <div className="pbmit-box-content-wrap">
                                ...
                                <div className="pbminfotech-box-author">
                                  <div className="pbmit-auther-content">
                                    <h3 className="pbminfotech-box-title">Olivia Cruz</h3>
                                    <div className="pbminfotech-testimonial-detail">Grorgia, USA</div>
                                  </div>
                                </div>
                                <div className="pbminfotech-box-img">
                                  <div className="pbmit-featured-img-wrapper">
                                    <div className="pbmit-featured-wrapper">
                                      <img src="images/homepage-1/reviewer/reviewer-01.jpg" className="img-fluid" alt="reviewer-04" />
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="pbminfotech-post-item">
                              <div className="pbmit-box-content-wrap">
                                ...
                                <div className="pbminfotech-box-img">
                                  <div className="pbmit-featured-img-wrapper">
                                    <div className="pbmit-featured-wrapper">
                                      <img src="images/homepage-1/reviewer/reviewer-02.jpg" className="img-fluid" alt="reviewer-04" />
                                    </div>
                                  </div>
                                </div>
                              </div>
                          ...
                          <article className="pbmit-testimonial-style-1 swiper-slide">
                            <div className="pbminfotech-post-item">
                              <div className="pbmit-box-content-wrap">
                                ...
                                <div className="pbminfotech-box-author">
                                  <div className="pbmit-auther-content">
                                    <h3 className="pbminfotech-box-title">Alex Zender</h3>
                                    <div className="pbminfotech-testimonial-detail">Grorgia, USA</div>
                                  </div>
                                </div>
                                <div className="pbminfotech-box-img">
                                  <div className="pbmit-featured-img-wrapper">
                                    <div className="pbmit-featured-wrapper">
                                      <img src="images/homepage-1/reviewer/reviewer-03.jpg" className="img-fluid" alt="reviewer-04" />
                                    </div>
                                  </div>
                                </div>
                              </div>
                          ...
                          <article className="pbmit-testimonial-style-1 swiper-slide">
                            <div className="pbminfotech-post-item">
                              <div className="pbmit-box-content-wrap">
                                ...
                                <div className="pbminfotech-box-author">
                                  <div className="pbmit-auther-content">
                                    <h3 className="pbminfotech-box-title">Robert Gold</h3>
                                    <div className="pbminfotech-testimonial-detail">Grorgia, USA</div>
                                  </div>
                                </div>
                                <div className="pbminfotech-box-img">
                                  <div className="pbmit-featured-img-wrapper">
                                    <div className="pbmit-featured-wrapper">
                                      <img src="images/homepage-1/reviewer/reviewer-04.jpg" className="img-fluid" alt="reviewer-04" />
                                    </div>
                                  </div>
                                </div>
                              </div>
            ...
            <section className="section-lgb pbmit-bg-color-light">
              <div className="container">
                <div className="swiper-slider" data-autoplay="true" data-loop="true" data-dots="false" data-arrows="false" data-columns={6} data-margin={0} data-effect="slide">
                  <div className="swiper-wrapper">
                    {/* Slide1 */}
                      ...
                      <div className="pbmit-border-wrapper">
                        <div className="pbmit-client-wrapper pbmit-client-with-hover-img">
                          ...
                          <div className="pbmit-client-hover-img">
                            <img src="images/homepage-1/client/client-global-01.png" className="img-fluid" alt />
                          </div>
                          <div className="pbmit-featured-img-wrapper">
                            <div className="pbmit-featured-wrapper">
                              <img src="images/homepage-1/client/client-grey-01.png" className="img-fluid" alt />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <article className="pbmit-client-style-1 swiper-slide">
                      <div className="pbmit-border-wrapper">
                        <div className="pbmit-client-wrapper pbmit-client-with-hover-img">
                          <h4 className="pbmit-hide">Client 12</h4>
                          <div className="pbmit-client-hover-img">
                            <img src="images/homepage-1/client/client-global-02.png" className="img-fluid" alt />
                          </div>
                          <div className="pbmit-featured-img-wrapper">
                            <div className="pbmit-featured-wrapper">
                              <img src="images/homepage-1/client/client-grey-02.png" className="img-fluid" alt />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <article className="pbmit-client-style-1 swiper-slide">
                      <div className="pbmit-border-wrapper">
                        <div className="pbmit-client-wrapper pbmit-client-with-hover-img">
                          <h4 className="pbmit-hide">Client 12</h4>
                          <div className="pbmit-client-hover-img">
                            <img src="images/homepage-1/client/client-global-03.png" className="img-fluid" alt />
                          </div>
                          <div className="pbmit-featured-img-wrapper">
                            <div className="pbmit-featured-wrapper">
                              <img src="images/homepage-1/client/client-grey-03.png" className="img-fluid" alt />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <article className="pbmit-client-style-1 swiper-slide">
                      <div className="pbmit-border-wrapper">
                        <div className="pbmit-client-wrapper pbmit-client-with-hover-img">
                          <h4 className="pbmit-hide">Client 12</h4>
                          <div className="pbmit-client-hover-img">
                            <img src="images/homepage-1/client/client-global-04.png" className="img-fluid" alt />
                          </div>
                          <div className="pbmit-featured-img-wrapper">
                            <div className="pbmit-featured-wrapper">
                              <img src="images/homepage-1/client/client-grey-04.png" className="img-fluid" alt />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <article className="pbmit-client-style-1 swiper-slide">
                      <div className="pbmit-border-wrapper">
                        <div className="pbmit-client-wrapper pbmit-client-with-hover-img">
                          <h4 className="pbmit-hide">Client 12</h4>
                          <div className="pbmit-client-hover-img">
                            <img src="images/homepage-1/client/client-global-05.png" className="img-fluid" alt />
                          </div>
                          <div className="pbmit-featured-img-wrapper">
                            <div className="pbmit-featured-wrapper">
                              <img src="images/homepage-1/client/client-grey-05.png" className="img-fluid" alt />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <article className="pbmit-client-style-1 swiper-slide">
                      <div className="pbmit-border-wrapper">
                        <div className="pbmit-client-wrapper pbmit-client-with-hover-img">
                          <h4 className="pbmit-hide">Client 12</h4>
                          <div className="pbmit-client-hover-img">
                            <img src="images/homepage-1/client/client-global-06.png" className="img-fluid" alt />
                          </div>
                          <div className="pbmit-featured-img-wrapper">
                            <div className="pbmit-featured-wrapper">
                              <img src="images/homepage-1/client/client-grey-06.png" className="img-fluid" alt />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <article className="pbmit-client-style-1 swiper-slide">
                      <div className="pbmit-border-wrapper">
                        <div className="pbmit-client-wrapper pbmit-client-with-hover-img">
                          <h4 className="pbmit-hide">Client 12</h4>
                          <div className="pbmit-client-hover-img">
                            <img src="images/homepage-1/client/client-global-07.png" className="img-fluid" alt />
                          </div>
                          <div className="pbmit-featured-img-wrapper">
                            <div className="pbmit-featured-wrapper">
                              <img src="images/homepage-1/client/client-grey-07.png" className="img-fluid" alt />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <article className="pbmit-client-style-1 swiper-slide">
                      <div className="pbmit-border-wrapper">
                        <div className="pbmit-client-wrapper pbmit-client-with-hover-img">
                          <h4 className="pbmit-hide">Client 12</h4>
                          <div className="pbmit-client-hover-img">
                            <img src="images/homepage-1/client/client-global-08.png" className="img-fluid" alt />
                          </div>
                          <div className="pbmit-featured-img-wrapper">
                            <div className="pbmit-featured-wrapper">
                              <img src="images/homepage-1/client/client-grey-08.png" className="img-fluid" alt />
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="container">
                <div className="text-center">
                  <div className="pbmit-heading-subheading-style-1 animation-style4">
                    <h4 className="pbmit-subtitle">Emergency call 123 4567 890</h4>
                    <h2 className="pbmit-title">We make the creative interior <br />solutions for <span id="js-rotating">manufacture, development, composition, explanation</span></h2>
                  </div>
                  <div className="play-button">
                    <a className="pbmit-icon pbmin-lightbox-video" href="https://www.youtube.com/watch?v=Sv2_JktdvmQ">
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-md-6">
                    <div className="blog-btn">
                      <a className="pbmit-btn pbmit-btn-outline" href="blog-grid-col-4.html">
                        <span className="pbmit-button-content-wrapper">
                          ...
                          <div className="post-item">
                            <div className="pbminfotech-box-content">
                              <div className="pbminfotech-content-inner">
                                <div className="pbmit-featured-img-wrapper">
                                  <div className="pbmit-featured-wrapper">
                                    <img src="images/homepage-1/blog/blog-01.jpg" className="img-fluid" alt /></div>
                                </div>
                          ...
                          <div className="post-item">
                            <div className="pbminfotech-box-content">
                              <div className="pbminfotech-content-inner">
                                <div className="pbmit-featured-img-wrapper">
                                  <div className="pbmit-featured-wrapper">
                                    <img src="images/homepage-1/blog/blog-02.jpg" className="img-fluid" alt /></div>
                                </div>
                                <div className="pbmit-meta-wraper">
                                  <div className="pbmit-meta-date-wrapper pbmit-meta-line">
                                    <div className="pbmit-meta-date">
                          ...
                          <div className="post-item">
                            <div className="pbminfotech-box-content">
                              <div className="pbminfotech-content-inner">
                                <div className="pbmit-featured-img-wrapper">
                                  <div className="pbmit-featured-wrapper">
                                    <img src="images/homepage-1/blog/blog-03.jpg" className="img-fluid" alt /></div>
                                </div>
                                <div className="pbmit-meta-wraper">
                                  <div className="pbmit-meta-date-wrapper pbmit-meta-line">
                                    <div className="pbmit-meta-date">
                      ...
                      <article className="pbmit-ele-blog pbmit-blog-style-3">
                        <div className="post-item d-flex">
                          <div className="pbmit-featured-container">
                            <div className="pbmit-bg-image" style={{ backgroundImage: 'url("images/homepage-1/blog/blog-04b.jpg")' }}>
                              <div className="pbmit-featured-img-wrapper">
                                <div className="pbmit-featured-wrapper">
                                  <img src="images/homepage-1/blog/blog-04.jpg" className="img-fluid" alt="blog-01" />
                                </div>
                              </div>
                            </div>
                          </div>
                          <div className="pbminfotech-box-wrap">
                            ...
                            <a className="pbmit-blog-btn" href="blog-single-details.html">
                              <span className="pbmit-button-icon">
                                <i className="pbmit-base-icon-pbmit-up-arrow" />
                              </span>
                            </a>
                ...
                <div className="container">
                  <div className="row align-items-center">
                    ...
                    <div className="col-md-4 pbmit-footer-right">
                      <span className="pbmit-address"> Chicago HQ Estica cop, <br />Macomb,MI 48042</span>
                    </div>
            ...
            <div className="pbmit-footer-text-area">
              <div className="container">
                <div className="pbmit-footer-text-inner">
                  <div className="row">
                    <div className="col-md-12">
                      <div className="pbmit-footer-copyright-text-area"> Copyright © 2024 <a href="index-2.html">Xinterio Demo1</a>, All Rights Reserved.</div>
                    </div>
                  </div>
                </div>
              </div>
