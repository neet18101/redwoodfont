                                        ...
                                        <div className="service-sidebar">
                                            ...
                                            <div className="all-post-list">
                                                <ul className="list-unstyled row justify-content-between container mx-auto">
                                                    ...
                                                    <li className='col-lg-5 col-5'><a href="service-details.html">
                                                        Exterior Doors</a></li>
                                                    <li className='col-lg-5 col-5'><a href="service-details.html">Sliding Glass Doors</a></li>
                                                    <li className='col-lg-5 col-5'><a href="service-details.html">Screen Doors</a></li>
                                                    <li className='col-lg-5 col-5'><a href="service-details.html">
                                                        Storm Doors</a></li>
                                                    <li className='col-lg-5 col-5'><a href="service-details.html">
                                                        French Doors</a></li>
                                                    ...
                                                    <li className='col-lg-5 col-5'><a href="service-details.html">Air Leaks</a></li>
                                                    <li className='col-lg-5 col-5'><a href="service-details.html">Damaged Door Jambs</a></li>
                                                    <li className='col-lg-5 col-5'><a href="service-details.html">
                                                        Rotting/Soft Wood</a></li>
                                                    <li className='col-lg-5 col-5'><a href="service-details.html">
                                                        Broken Door Locks</a></li>
                                                    <li className='col-lg-5 col-5'><a href="service-details.html">Screen Door Repairs</a></li>
                                                    <li className='col-lg-5 col-5'><a href="service-details.html">
                                                        And More!</a></li>
                                                </ul>
