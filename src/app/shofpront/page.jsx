                            ...
                            <article className="portfolio-single">
                                ...
                                <div className="pbmit-entry-content">
                                        ...
                                        <div className="service-sidebar">
                                            <div className="all-post-list">
                                                <ul className="list-unstyled row justify-content-between container mx-auto" >
                                                    <li className="w-90 col-lg-5 col-5 "><a href="#">Can be fabricated according to individual or standard specifications</a></li>
                                                    <li className=" col-lg-5 col-5"><a href="#">Numerous shop designs available</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">They're exceptionally resistant against corrosion</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">Strong, flexible and lasting allowing architects to be innovative with designs</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">Aluminum shopfronts can be improved with various other materials</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">Quite popular in the construction industry as they're designed for regular and heavy use</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">Provides options to supermarkets, restaurants, showrooms and stores</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">Offered in a range of styles colors and finishes, along with a selection of grips and doors</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="  sidebar">
                                        <div className="service-sidebar">
                                            <div className="all-post-list">
                                                <ul className="list-unstyled container mx-auto row justify-content-between">
                                                    <li className="col-lg-5 col-5"><a href="#">Automatic sliding door systems from Redwood Shopfront are modern, space-saving and elegant.</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">Automatic doors effectively contribute to energy saving and reduce annual heating and cooling costs. Doors open only when activated and automatically close so to eliminate the doors being left open. They also prevent air-conditioning from escaping and outside air and dust from entering.</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">The hands-free operation of automatic doors offer a optimal solution to hospitals and food factories where sanitation is essential. Automatic door with air-tight function can also prevent the entry of dust and dirt by increasing the air pressure of the room, which is suitable for operating rooms and other controlled environments.</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">Automatic revolving doors are used in the entrance areas for large and representative buildings. They combine architectural beauty with the greatest of functionality</a></li>
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="d-flex image-container">
                                                        <div className="image-box left">
                                                            <img
                                                                src="images/redWoodImg/Bi-Folding_Doors4.jpg"
                                                                className="img-fluid"
                                                                alt="Portfolio Detail 01"
                                                            />
                                                        </div>
                                                        ...
                                                        <div className="image-box right">
                                                            <img
                                                                src="images/redWoodImg/Sliding_Doors2.jpg"
                                                                className="img-fluid"
                                                                alt="Portfolio Detail 03"
                                                            />
                                                        </div>
                                    ...
                                    <div className=" sidebar">
                                        <div className="service-sidebar">
                                            <div className="all-post-list">
                                                <ul className="list-unstyled row justify-content-between container mx-auto">
                                                    <li className="col-lg-5 col-5 "><a href="#">Can be fabricated according to individual or standard specifications.</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">Numerous shop designs available.</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">They're exceptionally resistant against corrosion. </a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">Strong, flexible and lasting allowing architects to be innovative with designs.</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">Aluminum shopfronts can be improved with various other materials</a></li>
                                    ...
                                    <div className="pbmit-short-description next-section">
                                        <h3>Curtain Wall</h3>
                                        <p>
                                            The curtain walling window is a simple concept which gives your building an elegant top to bottom glass look while giving  support structure. <br /> Be it an abode or a shop, the windows reveal a lot about a place. They should never be considered as a mere part of the infrastructure as they add several dynamic benefits. From the aesthetical touch to a provider of foremost ventilation, windows cater it all. <br /> Hence for any shop owner it is very important to get the finest quality of windows available in the market. While one is on the lookout for the best type of windows available to enhance the quality of the building, “Curtain walling windows” will always be the right answer.
                                        </p>
                                    </div>
                                    <div className="pbmit-featured-img-wrapper">
                                        <div className="pf-img-box">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="d-flex image-container">
                                                        <div className="image-box left">
                                                            <img
                                                                src="images/redWoodImg/carswall.jpg"
                                                                className="img-fluid"
                                                                alt="Portfolio Detail 01"
                                                            />
                                                        </div>
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="d-flex image-container">
                                                        <div className="image-box left">
                                                            <img
                                                                src="images/redWoodImg/03-3.jpg"
                                                                className="img-fluid"
                                                                alt="Portfolio Detail 01"
                                                            />
                                                        </div>
                                                        <div className="image-box middle">
                                                            <img
                                                                src="images/redWoodImg/01-3.jpg"
                                                            />
                                                        </div>
                                                        <div className="image-box right">
                                                            <img
                                                                src="images/redWoodImg/07-2.jpg"
                                                                className="img-fluid"
                                                                alt="Portfolio Detail 03"
                                                            />
                                                        </div>
                                    ...
                                    <div className="  sidebar">
                                        <div className="service-sidebar">
                                            <div className="all-post-list">
                                                <ul className="list-unstyled row justify-content-between container mx-auto">
                                                    <li className="col-lg-5 col-5"><a href="#">
                                                        Retail Store Fronts</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">
                                                        Office Reception Entrances</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">
                                                        Showroom Entrances </a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">
                                                        Bar Entrances</a></li>
                                                    <li className="col-lg-5 col-5"><a href="#">
                                                        Glass Wall Partitioning</a></li>
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="d-flex image-container">
                                                        ...
                                                        <div className="image-box middle">
                                                            <img
                                                                src="images/redWoodImg/canopy.webp"
                                                            />
                                                        </div>
                                                        <div className="image-box right">
                                                            <img
                                                                src="images/redWoodImg/IMG-1.jpg"
                                                                className="img-fluid"
                                                                alt="Portfolio Detail 03"
                                                            />
                                                        </div>
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="d-flex image-container">
                                                        <div className="image-box left">
                                                            <img
                                                                src="images/redWoodImg/Timber_Window_3.jpg"
                                                                className="img-fluid"
                                                                alt="Portfolio Detail 01"
                                                            />
                                                        </div>
                                                        <div className="image-box middle">
                                                            <img
                                                                src="images/redWoodImg/Timber.webp"
                                                            />
                                                        </div>
                                                        <div className="image-box right">
                                                            <img
